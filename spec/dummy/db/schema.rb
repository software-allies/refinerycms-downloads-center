...
ActiveRecord::Schema.define(:version => 20140819140752) do
  ...
  create_table "refinery_categories_downloads", :force => true do |t|
    t.string   "title"
    t.text     "description"
  ...
  create_table "refinery_categories_subcategories", :force => true do |t|
    t.string   "title"
    t.text     "description"
    t.integer  "position"
    t.datetime "created_at",  :null => false
